                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: text('HASIL PENCARIAN BULAN '+month.toUpperCase()),
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, i){
                              ...
                              var data = dataTarget[i],
                                  tgt = data['target'] == null ? 0 : data['target'],
                                  jual = data['penjualan'] == null ? 0 : data['penjualan'],
                                  rtr = data['retur'] == null ? 0 : data['retur'],
                                  net = data['net'] == null ? 0 : data['net'],
                                  ach = data['ach'] == null ? 0 : data['ach'];
